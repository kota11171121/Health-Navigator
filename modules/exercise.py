...
class ExerciseFrame(ctk.CTkFrame):
    ...
    def __init__(self, master):
        ...
        date_label.pack(anchor="w",padx=25,pady=(20, 5))

        self.date_entry = DateEntry(form_card,width=18,date_pattern="yyyy-mm-dd",locale="ja_JP")

        self.date_entry.pack(padx=25,pady=(0, 10),anchor="w")
        ...
        walk_label.pack(anchor="w",padx=25,pady=(10, 5))
        ...
        self.walk_entry.pack(padx=25,pady=(0, 10),anchor="w")
        ...
        other_label.pack(anchor="w",padx=25,pady=(10, 5))
        ...
        self.other_text.pack(padx=25,pady=(0, 20),anchor="w")
    ...
    def save(self):
        ...
        other = self.other_text.get("1.0","end").strip()
        ...
        if walk_value < 0:
            ...
            return
        save_exercise(date,str(walk_value),other)
